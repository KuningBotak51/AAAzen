updateTime = "00:40:00 UTC+7"
updateDate = "26/09/2026"
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://raw.githubusercontent.com/KuningBotak51/AAAzen/refs/heads/main/details.json")
		return HttpService:JSONDecode(versionJson)
	end)

	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Outdated", "Get the new version at github.com/BlackID512/HikaruZenithRoblox")
		end
